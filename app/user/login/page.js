  ...
  return (
    ...
    <div className="min-h-screen bg-black flex flex-col justify-center">
      ...
      <div className="mx-auto w-72 sm:w-96 sm:w-96 md:w-96 lg:w-96 text-center">
        ...
        <h2 className="text-center text-l sm:text-2xl font-extrabold text-white mb-10">Sign in to your account</h2>
        <motion.div
          initial={{ opacity: 0}} // Initial animation state
          animate={{opacity: 1}} // Use animation controls
        ...
        >
          <form className="space-y-8" onSubmit={handleSubmit}>
            ...
            {/* Sign Up */}
            <div className="text-center">
              <a href="/user/signup" className="text-sm text-indigo-600 hover:text-indigo-500">
                Sign Up
              </a>
            </div>
          </form>
        ...
        >
        <button onClick={handleSignInWithGithub} type="button" className="mx-auto mt-5 bg-gray-900 hover:bg-purple-900 text-white py-3 px-8 rounded-md focus:outline-none focus:shadow-outline flex">
