  ...
  return (
    <div className="justify-center text-center">
      ...
      { streamStartedNoti && (
        ...
        <span>Stream Started! Will start reflecting on your Youtube Dasboard soon.</span><u><a href="#" onClick={(e) => {setStreamStartedNoti(false)}} className="text-right">close</a></u>
      </div>
      )}
      ...
      <div className="flex justify-center mb-10">
        ...
        {streamStarted?
          <button onClick={stopStreaming} type="button" className="text-gray-900 bg-red border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:text-white dark:border-gray-600 dark:hover:bg-red-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">
            Stop Streaming
          </button> : 
          <button onClick={startStreaming} type="button" className="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700">
            Start Streaming
          </button>
        }
      </div>
